the collection of my notes (or rather, the decently written ones) for the bsc computer science at sapienza ! 

some notes are handwritten (via my tablet), some are pdfs (and .tex files) written with LaTeX and others are links to my [quartz](https://aglaianorza.github.io/notesig/) (the original files (.md) can be found in my [vault](https://github.com/AglaiaNorza/obsidian-vault))

> they're here mainly as a resource for friends who might be absent from class :) and because i strongly believe in open knowledge
 
> (there might be some mistakes !) (feel free to contact me and i'll absolutely fix them ! (or you can fix them yourself if you want))
